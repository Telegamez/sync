...
This document describes the authentication system implemented for SwenSync, enabling user sign-in, registration, and OAuth integration with Supabase.

## Overview

SwenSync uses Supabase for authentication, supporting:
...
| Cookie (`swensync-auth`) | Server-side middleware authentication checks |
